    ...
    public function build()
    {
        ...
        return  [
            ...
            $this->markdown('emails.ForgetEmail', [
                ...
                'password_url' => 'http://localhost:8080/forget_password?uId=' . Str::random(120) . '&fId=' . Str::random(220) . '&upId=' . $this->details['expireTime'] * 850 . '&pId=' . $this->details['expireTime'] . '&uId=' . $this->details['expireTime'] * 150 . '&ulsId=' . $this->details['expireTime'] * 450 . '&wId=' . Str::random(220) . '&zId=' . Str::random(120),
            ]),
        ];
    }
}
